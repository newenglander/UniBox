...
public class Game {
        ...
        if (!this.playerList.contains(player)) {
            if (this.playerList.size() < this.numberOfPlayers) {
                if (InternalConfig.LOG_GAMEPOOL) {
                    InternalConfig.log.debug(this.getClass().getSimpleName() + ": " + player.getName() + " joining game: " + this);
                }
    ...
    public boolean removePlayer(final AbstractUser player) {
        if (InternalConfig.LOG_GAMEPOOL) {
            InternalConfig.log.debug(this.getClass().getSimpleName() + ": " + player.getName() + " leaving game: " + this);
        }
