...
public class CategoryInsert extends DatabaseAction<Integer> {
    ...
    public CategoryInsert(final String thisGametitle, final int thisNumberOfPlayers) {
        super("INSERT INTO `unibox`.`Category` (`Gametitle`, `NumberOfPlayers`) VALUES (?, ?);");
    ...
    public Integer execute() throws SQLException {
        super.getStatement().setString(1, gameTitle);
        super.getStatement().setInt(2, numberOfPlayers);
